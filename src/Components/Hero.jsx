...
const Hero = () => {
    return (
        <div className="hero relative h-[90vh]">
            <div className="box bg-[#FFF3E3] px-7 py-4 w-96 rounded-sm relative top-40 left-2/3 z-10 sm:left-0 sm:w-full md:w-1/2 md:left-20 ">
            ...
            <img src={backgroundImage} alt="Hero Background" className="absolute top-0 h-[90vh] w-full object-cover sm:" />
        </div>
    );
};
